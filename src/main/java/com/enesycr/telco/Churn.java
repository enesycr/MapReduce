 ...
 * @project MapReduce
 */
public class Churn extends Configured implements Tool {
  private static Logger logger = Logger.getLogger(Churn.class);

  public static void main(String[] args) throws Exception {
    try {
      int res = ToolRunner.run(new Configuration(), (Tool) new Churn(), args);
      System.exit(res);
    } catch (Exception e) {
      e.printStackTrace();
      System.exit(255);
  ...
  public int run(String[] args) throws Exception {
    ...
    job.setCombinerClass(ChurnReducer.class);
